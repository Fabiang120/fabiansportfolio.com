    ...
    return (
        <section className="projects-section flex flex-col justify-center relative ">
            <div className="projects-grid">
                <div className="Project1 min-h-screen md:h-screen flex flex-col md:flex-row items-center relative pl-0 md:pl-20 ">
                    ...
                    <div className="laptop w-full md:w-1/2 md:left-[-10%] relative order-1 md:order-2">
                        {/* ProjectTag - positioned absolutely behind */}
                        <ProjectTag className={styles.projectTag} />
                        {/* Laptop wrapper - in front */}
                        <div className="w-[120%] -ml-[10%] md:min-w-[180%] relative top-[6%] z-10">
                            <Laptop screenImage="/images/parting.png" />
                        </div>
                    </div>
                </div>
                <div className="Project2 min-h-screen md:h-screen flex flex-col md:flex-row items-center relative pl-0 md:pl-20">
                    <div className={styles.textarea}>
                    ...
                    <div className="laptop w-full md:w-1/2 relative md:left-[-10%] order-1 md:order-2">
                        {/* ProjectTag - positioned absolutely behind */}
                        <ProjectTag className={styles.projectTag} />
                        {/* Laptop wrapper - in front */}
                        <div className="w-[120%] -ml-[10%] md:min-w-[180%] relative top-[6%] z-10">
                ...
                <div className="Project3 min-h-screen md:h-screen flex flex-col md:flex-row items-center relative pl-0 md:pl-20">
                    <div className={styles.textarea}>
