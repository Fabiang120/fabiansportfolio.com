    ...
    return (
        <section className="projects-section border flex flex-col justify-center relative border-white">
            <div className="projects-grid">
                <div className="Project1 h-screen flex items-center relative border border-white overflow-hidden">
                    ...
                    <div className="laptop flex-1 h-full flex flex-col justify-end items-end">
