    ...
    useEffect(() => {
        pathRefs.current.forEach((path, index) => {
            if (path) {
                ...
                path.style.animation = `drawLine 3s ease-in ${index * 0.4}s forwards, fillIn 3s ease-in ${index * 0.4}s forwards`;
            }
        });
    }, []);
