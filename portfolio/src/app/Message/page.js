    ...
    return (
        <>
            ...
            <div className="min-h-screen relative grid grid-cols-1 gap-12 lg:grid-cols-[1fr_1fr] lg:gap-40 ">
                ...
                <div className="contact-form p-8 rounded-xl justify-self-center">
                    <motion.div
                    ...
                    >
                        ...
                        >
                            <g transform="translate(0.000000,412.000000) scale(0.050000,-0.050000)" fill="#06b6d4" stroke="none">
                    ...
                    <input type="email" className="bg-transparent border-b border-cyan-500 w-full py-2 mb-8 outline-none" />
                    <p className="mt-4 text-[0.95rem] sm:text-base md:text-lg leading-relaxed text-gray-300">Message</p>
                    <textarea className="bg-transparent border-b border-cyan-500 w-full py-2 mb-8 outline-none resize-none" rows={1} />
                    <motion.button
