...
export default function ConAmiPage({ portal }) {
    const handleClick = () => {
            ...
            <div className="flex flex-col">
                <div className="relative h-screen flex flex-col align-center">
                    ...
                    <div className="relative z-10 px-20 md:px-40 lg:px-80 py-45">
                        ...
                        >
                            Python, Next.js, React, Tailwind CSS, FastAPI, PostgreSQL
                        </MotionP>
                        ...
                        >
                            Co-architected and developed ConAmi in a three-person team, a
                            language exchange platform connecting English and Spanish speakers
                ...
                <div className="mt-70 h-screen px-6 sm:px-16 md:px-40 lg:px-80 py-45 flex flex-col justify-center items-center">
                    <div className="mb-40 px-4 md:px-20 lg:px-35">
                        ...
                        >
                            My group and I wanted to help connect people in the US with
                            individuals in Latin and Hispanic countries, providing a chance to
                            learn Spanish directly from those who want to teach or simply have
                            conversations. Learning a new language often comes with the fear of
                            speaking, so our mission with ConAmi is to remove that fear by
                            making language exchange approachable, seamless, and human-centered.
                        </MotionP>
                    </div>
                    ...
                    <MotionImg
                        ...
                        src="/images/ConAmi2.png"
                        alt="ConAmi App Interface"
                    />
                </div>
                ...
                <div className="mt-45 h-screen px-6 sm:px-16 md:px-40 lg:px-80 py-45 flex flex-col justify-center items-center">
                    <div className="px-4 md:px-20 lg:px-35">
                        ...
                        <MotionP
                            ...
                            className="mt-4 text-lg sm:text-xl md:text-2xl leading-relaxed text-gray-300 text-pretty max-w-xl"
                        >
                            Designed the full-stack architecture, implementing a Next.js and
                            React frontend communicating via REST APIs to a FastAPI backend.
                            Engineered the database with PostgreSQL and SQLAlchemy for
                            persistent user and messaging data, utilizing Alembic for database
                            migrations.
                        </MotionP>
                    </div>
                </div>
                ...
                <div className="mt-20 h-screen px-6 sm:px-16 md:px-40 lg:px-80 py-45 flex flex-col justify-center items-center">
                    <div className="px-4 md:px-20 lg:px-35">
                        ...
                        <MotionP
                            ...
                            className="mt-4 text-lg sm:text-xl md:text-2xl leading-relaxed text-gray-300 text-pretty max-w-xl"
                        >
                            We are currently in the process of building this app, working in
                            sprint cycles with detailed backlogging. We plan to add AI
                            conversation support within the chats, and we hope to see the
                            platform officially launched on the App Store in the future.
                        </MotionP>
